  ...
  return (
    <main className="article-page">
      ...
      <article className="article-body">
        ...
        <section>
          <h2>常見問題 FAQ</h2>
          <h3>Q1：協議離婚也一定可以請求民法第1057條的贍養費嗎？</h3>
          <p>
            不一定。民法第1057條的文義本身與判決離婚有關，實務上對法定贍養費的適用相對嚴格。協議離婚若要約定離婚後給付，通常更要看雙方協議內容本身如何約定。
          </p>

          <h3>Q2：贍養費和子女扶養費可以一起談嗎？</h3>
          <p>
            可以一起處理，但法律性質不同。前者是前配偶間的問題，後者是父母對未成年子女的責任，不能混成同一筆。
          </p>

          <h3>Q3：我沒有工作，就一定能請求贍養費嗎？</h3>
          <p>
            不一定。法院仍會看你是否符合民法第1057條要件，也會看年齡、身分、工作能力、生活程度及對方資力。
          </p>

          <h3>Q4：孩子跟我住，對方就一定要固定付錢嗎？</h3>
          <p>
